...
- SnapSwitch Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called SnapSwitch Lite. It should be a full-viewport timing puzzle where the player moves a bright switch marker between two rails, collects pulses, avoids red blockers, has a settings overlay, pause/resume, score, level, and clear keyboard/click controls. Keep it small but fully…
...
- Gameplay - SnapSwitch Lite
- Game Settings - SnapSwitch Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - SnapSwitch Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - SnapSwitch Lite
